  ...
  return (
    <nav className='fixed bottom-0 flex w-screen flex-col items-center justify-between bg-slate-200 md:static md:h-full md:w-1/4'>
      <ul className='flex w-full justify-evenly p-4 md:flex-col md:justify-start'>
        <Link to='/feed'>
          <li className='mt-1 flex w-full cursor-pointer content-between items-center text-lg'>
            <span className='flex w-full items-center'>
              <BsStars className='mx-1' />
              Feed
            </span>
            <span className='flex h-6 w-6 items-center justify-center rounded-[50%] bg-rose-300 font-heading text-sm font-bold shadow-sm'>
              1
            </span>
          </li>
        </Link>
