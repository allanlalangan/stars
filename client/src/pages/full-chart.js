    ...
    <section>
      ...
      <article>
        ...
        <ul>
          ...
          <li>{`Venus: ${selectedChart?.planets?.venus.position.toFixed(2)}° ${
            selectedChart?.planets?.venus.sign
          }`}</li>
          ...
          <li>{`Pluto: ${selectedChart?.planets?.pluto.position.toFixed(2)}° ${
            selectedChart?.planets?.pluto.sign
          }`}</li>
